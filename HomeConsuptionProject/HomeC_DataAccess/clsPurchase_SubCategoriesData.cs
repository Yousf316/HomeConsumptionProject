...
namespace HomeC_DataAccess
{
    public class clsPurchase_SubCategoriesData
    {
        ...
        static public void Insert_Purchase_SubCategories(ref int PSCategoryID, string CategoryName, int PCategoryID)
        {
        ...
        static public bool Update_Purchase_SubCategories(int PSCategoryID, string CategoryName, int PCategoryID)
        {
            int rowsAffected = 0;
            using (SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString))
        ...
        static public bool FindPurchase_SubCategories(int PSCategoryID, ref string SubCategoryName, ref int PCategoryID)
        {
            bool isFound = false;
        ...
        static public bool FindPurchase_SubCategories(ref int PSCategoryID, string SubCategoryName, ref int PCategoryID)
        {
            bool isFound = false;
